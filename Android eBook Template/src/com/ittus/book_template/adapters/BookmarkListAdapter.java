...
public class Ebook extends BaseAdapter {

	private List<Bookmark> data;
	private Context context;

	public Ebook (Context context, List<Bookmark> data) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.bAction = convertView.findViewById(R.id.btn_delete);
